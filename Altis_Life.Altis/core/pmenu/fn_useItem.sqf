...
switch (true) do {
    case (_item in ["waterBottle","coffee","redgull","winebottle","moonshine"]): {
    ...
    case (_item in ["apple","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","donuts","hamburger","peach","frog"]): {
