...
/* System Settings */
    ...
    news_broadcast_cost = 1000000000; //Cost for a player to send a news station broadcast.
    ...
    service_chopper = 25000; //Cost to service chopper at chopper service station(Repair/Refuel).
    ...
    gang_upgradeBase = 250000; //The base cost for purchasing additional slots in a gang
    ...
    animaltypes_hunting[] = { "Rabbit_F" }; //Classnames of aniamls you can hunt/gut
    ...
    sendtoJail_locations[] = 
		...
		}; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    ...
    vehicle_purchase_multiplier_COP = .7; //Cop Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_MEDIC = .7; //Medic Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_OPFOR = -1; // -- NOT IN USE -- Simply left in for east support.

    /* Vehicle Rental Prices */
    vehicle_rental_multiplier_CIVILIAN = .7; //Civilian Vehicle Rental Price = Config_Vehicle price * multiplier
