...
//Medic-Shops
    class medicshop {
        name = "STR_Shops_MedicShop";
        side = "med";
        license = "";
        level[] = { "", "", -1, "" };
        items[] = {
			switch (life_mediclevel) {
				case 1:
					"waterBottle",
					"hamburger",
					"redgull"
...
//Civ-Shops
    ...
    class heimwerkerprofi {
        name = "STR_Shops_Heimwerkerprofi";
        side = "civ";
        license = "";
        level[] = { "", "", -1, "" };
        items[] = {
...
class VirtualItems {
	...
	class fishingnet {
		variable = "fishingnet";
		displayName = "STR_Item_Fishingnet";
		weight = 3;
		buyPrice = 1900;
		sellPrice = 1899;
		illegal = false;
...
*/
    ...
    class winebottle {
        variable = "winebottle";
        displayName = "STR_Item_WineBottle";
        weight = 2;
        buyPrice = -1;
        sellPrice = 1200;
        illegal = false;
    ...
    class relic_licensed {
        variable = "reliclicensed";
        displayName = "STR_Item_RelicL";
        weight = 12;
        buyPrice = -1;
        sellPrice = 6000;
        illegal = false;
